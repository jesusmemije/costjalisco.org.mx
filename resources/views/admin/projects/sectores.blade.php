  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="form-row">
        ...
        <button type="submit" class="btn btn-primary btn-sm" data-toggle="modal" data-title='Nuevo sector' data-target="#modalnewData" data-route='{{route("project.savesector")}}' >
            ...
            @foreach ($sectores as $sector)
              <tr>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group">
                  <button class="btn btn-sm btn-dark shadow-sm" data-id='{{$sector->id}}' data-toggle="modal" data-name='{{$sector->titulo}}' data-target="#deleteUserModal" data-route='{{route("project.deletesector")}}'>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
       <div class="form-row">
        ...
        <button  id="newsubsector"  type="submit" class="btn btn-primary btn-sm" data-toggle="modal" data-title='Nuevo subsector' data-target="#modalnewData" data-route='{{route("project.savesubsector")}}'  >
        <i class="fa fa-plus-circle" aria-hidden="true"></i>
        Agregar nuevo
      </button>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @csrf
        <label for="name">Nombre del subsector</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-sm">Guardar sector</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="deleteUserModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Seguro que desea eliminar el sector <strong><span class="name-user"></span></strong>?</p>
        </div>
        <div class="modal-footer">
          ...
          <form id="formDelete" action="" data-action=" " method="POST">
            ...
            <input type="hidden" name="" id="to_id">
          </form>
        </div>
      </div>
    </div>
          ...
          trHTML = '';
                        $.each(resp, function (i, userData) {
                                ...
                                trHTML +=
                                    ...
                                    + resp[i].titulo
                                    + '</td>><td>'
                                    + '<a href=""  style="margin-right: 5px;" class="btn btn-sm btn-info shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i>Editar</a>'
                                    + '<button class="btn btn-sm btn-dark shadow-sm" data-toggle="modal" data-target="#deleteUserModal"><i class="fas fa-trash fa-sm text-white-50"></i>Eliminar</button>'
                                    + '</tr>';
