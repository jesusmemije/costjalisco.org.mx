...
<button data-title="Editar origen del recurso" data-labeltxt='sector' data-labelbi='Nombre del recurso' data-id='{{$tipo->id}}' data-btn='Editar origen del recurso' data-toggle="modal" data-name='{{$tipo->titulo}}' data-target="#modaleditData" data-route='{{route("resource.update",$tipo->id)}}' data-target="#modaleditData" class="btn btn-sm btn-info shadow-sm">
...
<button class="btn btn-sm btn-dark shadow-sm" data-labeltxt='tipo de proyecto:' data-id='{{$tipo->id}}' data-toggle="modal" data-name='{{$tipo->titulo}}' data-target="#deleteUserModal" data-route='{{route("resource.destroy",$tipo->id)}}'>
