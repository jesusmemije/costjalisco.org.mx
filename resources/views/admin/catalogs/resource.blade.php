  ...
  <div class="card shadow md-12">
    <div class="card-header py-3">
       <div class="form-row">
        ...
        <button  id="newsubsector" data-labeltxt='origen del recurso'  data-lbl='Nombre del origen del recurso' data-btn='Guardar origen del recurso' class="btn btn-primary btn-sm" data-toggle="modal" data-title='Nuevo origen del recurso' data-target="#modalnewData" data-route='{{route("catalogs.saveresource")}}'  >
...
<button data-title="Editar origen del recurso" data-labeltxt='sector' data-labelbi='Nombre del recurso' data-id='{{$tipo->id}}' data-btn='Editar origen del recurso' data-toggle="modal" data-name='{{$tipo->titulo}}' data-target="#modaleditData" data-route='{{route("catalogs.editresource")}}' data-target="#modaleditData" class="btn btn-sm btn-info shadow-sm">
...
<button class="btn btn-sm btn-dark shadow-sm" data-labeltxt='tipo de proyecto:' data-id='{{$tipo->id}}' data-toggle="modal" data-name='{{$tipo->titulo}}' data-target="#deleteUserModal" data-route='{{route("catalogs.deleteresource")}}'>
