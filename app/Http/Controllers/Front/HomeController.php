        ...
        $personas_beneficias = DB::table('project')
           ...
           ->groupBy('project_organizations.id_organization','organization.name')
            ...
            foreach ($proyectos as $proyecto) {
                $count_projects=$count_projects+$proyecto->total_proyectos;
            }

           
           // $beneficiadas=$beneficiadas[0]->total_p_beneficiada;
           
        return view('front.statistics',['tt'=>$count_projects,'costofinalizacion_contrato'=>$costofinalizacion_contrato,
