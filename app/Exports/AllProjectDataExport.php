           ...
           //   $finobject->observaciones = $lastfin->observaciones;
                ...
                array_push(
                    ...
                    [
                        ...
                        "id" => (string) "oc4ids-mxdy6h-".$project->ocid,
                        "updated" => (string) $updated,
                        "title" =>  (string) $project->title,
                        "description" => (string) $project->description,
                        "status" => (string) $status->codigo,
                        "sector" =>  [$subsector->codigo],
                        "purpose" => (string) $project->purpose,
                        "type" => (string) $type->codigo,
                        ...
                        "budget" => json_encode($budgetobj),

                        "parties"=> json_encode( $parties,JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES),

                        "publicAuthority" => ["name" => $project->name_organization, "id" => (string)$project->publicAuthority_id],
                        "documents" => json_encode($docs,JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES),
                        "contractingProcesses" =>
                        ...
                        "completion" =>json_encode( $finobject),
